...
//			},
//			DeviceGetHostname_v1Func: func(device nvml.Device) (nvml.Hostname_v1, nvml.Return) {
...
//			},
//			DeviceGetUnrepairableMemoryFlagFunc: func(device nvml.Device) (nvml.UnrepairableMemoryStatus_v1, nvml.Return) {
//				panic("mock out the DeviceGetUnrepairableMemoryFlag method")
//			},
...
//			},
//			DeviceGetVgpuSchedulerLog_v2Func: func(device nvml.Device) (nvml.VgpuSchedulerLogInfo_v2, nvml.Return) {
...
//			},
//			DeviceReadPRMCounters_v1Func: func(device nvml.Device, pRMCounterList_v1 nvml.PRMCounterList_v1) nvml.Return {
...
//			},
//			DeviceSetHostname_v1Func: func(device nvml.Device, hostname_v1 nvml.Hostname_v1) nvml.Return {
...
//			},
//			DeviceWorkloadPowerProfileUpdateProfiles_v1Func: func(device nvml.Device, workloadPowerProfileUpdateProfiles_v1 *nvml.WorkloadPowerProfileUpdateProfiles_v1) nvml.Return {
...
//			},
//			GpuInstanceGetVgpuSchedulerLog_v2Func: func(gpuInstance nvml.GpuInstance) (nvml.VgpuSchedulerLogInfo_v2, nvml.Return) {
...
//			},
//			GpuInstanceGetVgpuSchedulerState_v2Func: func(gpuInstance nvml.GpuInstance) (nvml.VgpuSchedulerStateInfo_v2, nvml.Return) {
...
type Interface struct {
	...
	// DeviceGetUnrepairableMemoryFlagFunc mocks the DeviceGetUnrepairableMemoryFlag method.
	DeviceGetUnrepairableMemoryFlagFunc func(device nvml.Device) (nvml.UnrepairableMemoryStatus_v1, nvml.Return)
	...
	calls struct {
		...
		// DeviceGetUnrepairableMemoryFlag holds details about calls to the DeviceGetUnrepairableMemoryFlag method.
		DeviceGetUnrepairableMemoryFlag []struct {
			// Device is the device argument value.
			Device nvml.Device
		}
		...
		DeviceReadPRMCounters_v1 []struct {
			// Device is the device argument value.
			Device nvml.Device
			// PRMCounterList_v1 is the pRMCounterList_v1 argument value.
			PRMCounterList_v1 nvml.PRMCounterList_v1
		}
		...
		DeviceSetHostname_v1 []struct {
			// Device is the device argument value.
			Device nvml.Device
			// Hostname_v1 is the hostname_v1 argument value.
			Hostname_v1 nvml.Hostname_v1
		}
		...
		DeviceWorkloadPowerProfileUpdateProfiles_v1 []struct {
			// Device is the device argument value.
			Device nvml.Device
			// WorkloadPowerProfileUpdateProfiles_v1 is the workloadPowerProfileUpdateProfiles_v1 argument value.
			WorkloadPowerProfileUpdateProfiles_v1 *nvml.WorkloadPowerProfileUpdateProfiles_v1
		}
	...
	lockDeviceGetUnrepairableMemoryFlag                  sync.RWMutex
...
func (mock *Interface) DeviceGetHostname_v1(device nvml.Device) (nvml.Hostname_v1, nvml.Return) {
...
// DeviceGetUnrepairableMemoryFlag calls DeviceGetUnrepairableMemoryFlagFunc.
func (mock *Interface) DeviceGetUnrepairableMemoryFlag(device nvml.Device) (nvml.UnrepairableMemoryStatus_v1, nvml.Return) {
	if mock.DeviceGetUnrepairableMemoryFlagFunc == nil {
		panic("Interface.DeviceGetUnrepairableMemoryFlagFunc: method is nil but Interface.DeviceGetUnrepairableMemoryFlag was just called")
	}
	callInfo := struct {
		Device nvml.Device
	}{
	...
	mock.lockDeviceGetUnrepairableMemoryFlag.Lock()
	mock.calls.DeviceGetUnrepairableMemoryFlag = append(mock.calls.DeviceGetUnrepairableMemoryFlag, callInfo)
	mock.lockDeviceGetUnrepairableMemoryFlag.Unlock()
	return mock.DeviceGetUnrepairableMemoryFlagFunc(device)
}

// DeviceGetUnrepairableMemoryFlagCalls gets all the calls that were made to DeviceGetUnrepairableMemoryFlag.
// Check the length with:
//
//	len(mockedInterface.DeviceGetUnrepairableMemoryFlagCalls())
func (mock *Interface) DeviceGetUnrepairableMemoryFlagCalls() []struct {
	Device nvml.Device
} {
	var calls []struct {
		Device nvml.Device
	}
	mock.lockDeviceGetUnrepairableMemoryFlag.RLock()
	calls = mock.calls.DeviceGetUnrepairableMemoryFlag
	mock.lockDeviceGetUnrepairableMemoryFlag.RUnlock()
	return calls
}
...
func (mock *Interface) DeviceGetVgpuSchedulerLog_v2(device nvml.Device) (nvml.VgpuSchedulerLogInfo_v2, nvml.Return) {
	...
	return mock.DeviceGetVgpuSchedulerLog_v2Func(device)
}
...
func (mock *Interface) DeviceReadPRMCounters_v1(device nvml.Device, pRMCounterList_v1 nvml.PRMCounterList_v1) nvml.Return {
	...
	callInfo := struct {
		...
		Device:            device,
		PRMCounterList_v1: pRMCounterList_v1,
	}
	...
	return mock.DeviceReadPRMCounters_v1Func(device, pRMCounterList_v1)
}
...
func (mock *Interface) DeviceSetHostname_v1(device nvml.Device, hostname_v1 nvml.Hostname_v1) nvml.Return {
	...
	return mock.DeviceSetHostname_v1Func(device, hostname_v1)
}
...
func (mock *Interface) DeviceWorkloadPowerProfileUpdateProfiles_v1(device nvml.Device, workloadPowerProfileUpdateProfiles_v1 *nvml.WorkloadPowerProfileUpdateProfiles_v1) nvml.Return {
	...
	callInfo := struct {
		...
		Device:                                device,
		WorkloadPowerProfileUpdateProfiles_v1: workloadPowerProfileUpdateProfiles_v1,
	}
	...
	return mock.DeviceWorkloadPowerProfileUpdateProfiles_v1Func(device, workloadPowerProfileUpdateProfiles_v1)
}
...
func (mock *Interface) GpuInstanceGetVgpuSchedulerLog_v2(gpuInstance nvml.GpuInstance) (nvml.VgpuSchedulerLogInfo_v2, nvml.Return) {
	...
	return mock.GpuInstanceGetVgpuSchedulerLog_v2Func(gpuInstance)
}
...
func (mock *Interface) GpuInstanceGetVgpuSchedulerState_v2(gpuInstance nvml.GpuInstance) (nvml.VgpuSchedulerStateInfo_v2, nvml.Return) {
	...
	return mock.GpuInstanceGetVgpuSchedulerState_v2Func(gpuInstance)
}
