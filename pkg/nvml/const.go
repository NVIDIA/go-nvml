...
const (
	nvmlSUCCESS                         Return = iota
	nvmlERROR_UNINITIALIZED             Return = 1
	nvmlERROR_INVALID_ARGUMENT          Return = 2
	nvmlERROR_NOT_SUPPORTED             Return = 3
	nvmlERROR_NO_PERMISSION             Return = 4
	nvmlERROR_ALREADY_INITIALIZED       Return = 5
	nvmlERROR_NOT_FOUND                 Return = 6
	nvmlERROR_INSUFFICIENT_SIZE         Return = 7
	nvmlERROR_INSUFFICIENT_POWER        Return = 8
	nvmlERROR_DRIVER_NOT_LOADED         Return = 9
	nvmlERROR_TIMEOUT                   Return = 10
	nvmlERROR_IRQ_ISSUE                 Return = 11
	nvmlERROR_LIBRARY_NOT_FOUND         Return = 12
	nvmlERROR_FUNCTION_NOT_FOUND        Return = 13
	nvmlERROR_CORRUPTED_INFOROM         Return = 14
	nvmlERROR_GPU_IS_LOST               Return = 15
	nvmlERROR_RESET_REQUIRED            Return = 16
	nvmlERROR_OPERATING_SYSTEM          Return = 17
	nvmlERROR_LIB_RM_VERSION_MISMATCH   Return = 18
	nvmlERROR_IN_USE                    Return = 19
	nvmlERROR_MEMORY                    Return = 20
	nvmlERROR_NO_DATA                   Return = 21
	nvmlERROR_VGPU_ECC_NOT_SUPPORTED    Return = 22
	nvmlERROR_INSUFFICIENT_RESOURCES    Return = 23
	nvmlERROR_FREQ_NOT_SUPPORTED        Return = 24
	nvmlERROR_ARGUMENT_VERSION_MISMATCH Return = 25
	nvmlERROR_DEPRECATED                Return = 26
	nvmlERROR_NOT_READY                 Return = 27
	nvmlERROR_GPU_NOT_FOUND             Return = 28
	nvmlERROR_INVALID_STATE             Return = 29
	nvmlERROR_UNKNOWN                   Return = 999
)
