...
var (
	...
	DeviceGetUnrepairableMemoryFlag                  = libnvml.DeviceGetUnrepairableMemoryFlag
...
type Interface interface {
	...
	DeviceGetHostname_v1(Device) (Hostname_v1, Return)
	...
	DeviceGetUnrepairableMemoryFlag(Device) (UnrepairableMemoryStatus_v1, Return)
	...
	DeviceGetVgpuSchedulerLog_v2(Device) (VgpuSchedulerLogInfo_v2, Return)
	...
	DeviceReadPRMCounters_v1(Device, PRMCounterList_v1) Return
	...
	DeviceSetHostname_v1(Device, Hostname_v1) Return
	...
	DeviceWorkloadPowerProfileUpdateProfiles_v1(Device, *WorkloadPowerProfileUpdateProfiles_v1) Return
	...
	GpuInstanceGetVgpuSchedulerLog_v2(GpuInstance) (VgpuSchedulerLogInfo_v2, Return)
	GpuInstanceGetVgpuSchedulerState(GpuInstance) (VgpuSchedulerStateInfo, Return)
	GpuInstanceGetVgpuSchedulerState_v2(GpuInstance) (VgpuSchedulerStateInfo_v2, Return)
...
type Device interface {
	...
	GetHostname_v1() (Hostname_v1, Return)
	GetIndex() (int, Return)
	...
	GetUnrepairableMemoryFlag() (UnrepairableMemoryStatus_v1, Return)
	...
	GetVgpuSchedulerLog_v2() (VgpuSchedulerLogInfo_v2, Return)
	...
	ReadPRMCounters_v1(PRMCounterList_v1) Return
	...
	SetHostname_v1(Hostname_v1) Return
	...
	WorkloadPowerProfileUpdateProfiles_v1(*WorkloadPowerProfileUpdateProfiles_v1) Return
}
...
type GpuInstance interface {
	...
	GetVgpuSchedulerState_v2() (VgpuSchedulerStateInfo_v2, Return)
